...
namespace DeliverySystem.Migrations
{
    ...
    [Migration("20210512080919_UserDeliveryRelation")]
    partial class UserDeliveryRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeliverySystem.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DeliverySystem.Models.Delivery", b =>
                {
                    b.HasOne("DeliverySystem.Models.User", "User")
                        .WithMany("Deliveries")
